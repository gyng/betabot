...
Butbot is a chatbot that aims to be protocol agnostic, easy to deploy and simple to develop for. Butbot supersedes [HidoiBot](https://github.com/gyng/HidoiBot).
...
Butbot uses [Sequel](https://github.com/jeremyevans/sequel) ORM backed by SQLite. Plugins can either create their own databases or access a shared database.
...
## License
Butbot is licensed under the MIT License.